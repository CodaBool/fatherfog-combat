...
**Setup:**
 ...
 - Game System Version: [e.g. Mothership 0.6]
 ...
 **Isolated?**
 Does the bug still occur when all other modules are disabled? If you have too many modules to disable, just skip over this.
